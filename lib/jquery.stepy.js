...
;(function($) {
  ...
  var methods = {
    init: function(settings) {
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: 'javascript:void(0);', 'class': 'btn button-back', html: self.opt.backLabel };
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: 'javascript:void(0);', 'class': 'btn button-next', html: self.opt.nextLabel };
